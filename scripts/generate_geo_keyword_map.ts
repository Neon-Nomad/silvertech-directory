...
if (isExpanded) {
  ...
  for (const city of cities) {
    const targetUrl = `https://silvertechdirectory.com/assisted-living/${city.stateSlug}/cities/${city.citySlug}/`;
  ...
  for (const city of cities) {
    ...
    rows.push(
      [
        ...
        city.cityName,
        city.citySlug,
        `https://silvertechdirectory.com/assisted-living/${city.stateSlug}/cities/${city.citySlug}/`,
        keywords[0],

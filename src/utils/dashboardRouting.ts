export type DashboardTab = 'overview' | 'listings' | 'leads' | 'qa' | 'billing' | 'vault' | 'help';

const CANONICAL_TABS: DashboardTab[] = ['overview', 'listings', 'leads', 'qa', 'billing', 'vault', 'help'];
...
export const normalizeDashboardTab = (value: string | null | undefined): DashboardTab | null => {
  ...
  if (normalized === 'lineage') return 'vault';

const e="tennessee",n=`# Tennessee Medicaid Programs: A Comprehensive Guide to TennCare and the CHOICES Program
...
## Understanding TennCare: Tennessee's Managed Care Medicaid System
...
### The Foundation of Long-Term Services and Supports (LTSS)
...
## The CHOICES in Long-Term Care Program: Your Pathway to Assisted Living
...
1.  **Older Adults:** Individuals aged 65 and older.
2.  **Adults with Physical Disabilities:** Individuals aged 21 and older.
...
### Detailed Breakdown of CHOICES Groups
...
| CHOICES Group | Primary Service Setting | Medical Eligibility Requirement | Financial Eligibility Requirement | Key Services Covered |
| :--- | :--- | :--- | :--- | :--- |
| **Group 1** | Nursing Facility | Must require the **Nursing Facility Level of Care (NFLOC)** | Must qualify financially for Medicaid LTSS | All services provided in a licensed nursing home |
| **Group 2** | Home and Community Based Services (HCBS) | Must require the **Nursing Facility Level of Care (NFLOC)** | Must qualify financially for Medicaid LTSS | HCBS, including services in assisted living facilities (ALFs) |
| **Group 3** | Home and Community Based Services (HCBS) | Must be **"at risk"** of needing NFLOC | Must be receiving SSI or qualify for Medicaid LTSS | Limited HCBS, focused on preventing institutionalization |
...
#### **Group 2: Home and Community Based Services (HCBS) for NFLOC**
...
**Assisted Living Coverage through Group 2:**
The CHOICES Group 2 waiver is the mechanism that provides financial assistance for services in an Assisted Care Living Facility (ACLF), which is Tennessee's term for assisted living. While the program does not pay for room and board, it covers the cost of personal care services, such as:
*   **Personal Care Services:** Assistance with ADLs (bathing, dressing, toileting).
*   **Homemaker Services:** Light housekeeping, laundry.
*   **Attendant Care:** Services provided by a personal care attendant.
*   **Adult Day Care:** Structured programs outside the home.
...
#### **Group 3: HCBS for "At Risk" Individuals**
...
## Eligibility Requirements for CHOICES
...
*   **For Groups 1 and 2:** The applicant must meet the full NFLOC criteria.
*   **For Group 3:** The applicant must be determined to be "at risk" of meeting the NFLOC criteria in the near future without intervention.
...
| Financial Criteria | Limit for Single Applicant (2025) | Limit for Married Couple (Both Applying) (2025) |
| :--- | :--- | :--- |
| **Monthly Income** | Cannot exceed **$2,901** (300% of the SSI Federal Benefit Limit) | Both incomes are counted, but complex rules apply |
| **Countable Assets** | Cannot exceed **$2,000** | Cannot exceed **$3,000** |

**Key Financial Considerations:**
*   **Income:** If an applicant's income exceeds the limit, they may still qualify by establishing a **Qualifying Income Trust** (also known as a Miller Trust) to hold the excess income [3].
*   **Assets:** Certain assets are considered **exempt** (non-countable), most notably the applicant's primary residence (up to a certain equity limit, provided they intend to return home), one vehicle, and personal belongings. All other assets, such as bank accounts, stocks, and secondary properties, are countable.
*   **Look-Back Period:** Tennessee enforces a **five-year look-back period** for all asset transfers. Any uncompensated transfer of assets for less than fair market value during this period can result in a penalty period of Medicaid ineligibility [3].

## The Application Process for TennCare CHOICES
...
1.  **Initial Contact:** The first step is to contact the **Tennessee Bureau of TennCare** at **(800) 342-3145** or the local Area Agency on Aging and Disability (AAAD). They will conduct a preliminary screening.
2.  **Medical Assessment:** If the initial screening suggests a need for long-term care, a **Qualified Assessor** will be assigned to conduct a comprehensive medical assessment to determine the level of care needed (NFLOC or "at risk") [5].
3.  **Financial Application:** Simultaneously, the applicant must complete the financial application for Medicaid LTSS. This involves submitting extensive documentation of all income, assets, and financial transactions over the past five years.
4.  **Eligibility Determination:** The Tennessee Bureau of TennCare reviews both the medical assessment and the financial application. If both criteria are met, the applicant is deemed eligible for the CHOICES program.
5.  **Enrollment in an MCO:** Upon approval, the member is enrolled in one of the TennCare MCOs that administer the CHOICES program. A care coordinator from the MCO will then work with the member to develop an individualized service plan.
...
## Other TennCare Programs and Resources
...
*   **Employment and Community First CHOICES (ECF CHOICES):** This program is specifically for individuals with intellectual and developmental disabilities (IDD). It focuses on employment, community integration, and support services, operating under a separate set of eligibility rules [6].
*   **Katie Beckett Program:** This program allows certain children with severe disabilities who do not qualify for standard TennCare due to their parents' income to receive Medicaid coverage. Eligibility is based solely on the child's income and disability status [7].

## Conclusion: Securing Long-Term Care in Tennessee
...
*   **Source:** \`https://www.tn.gov/tenncare.html\`
*   **Title:** TennCare Home Page

[2] **TennCare Long-Term Services & Supports (LTSS)**
*   **Source:** \`https://www.tn.gov/tenncare/long-term-services-supports.html\`
*   **Title:** Long-Term Services & Supports

[3] **CHOICES Program Official Page**
*   **Source:** \`https://www.tn.gov/tenncare/long-term-services-supports/choices.html\`
*   **Title:** CHOICES

[4] **Types of TennCare: CHOICES for Long-term Care**
*   **Source:** \`https://www.elderlawetn.com/blog/05/types-of-tenncare\`
*   **Title:** Types of TennCare: CHOICES for Long-term Care

[5] **Applying for CHOICES to pay for your care in a nursing home or at home**
*   **Source:** \`https://las.org/wp-content/uploads/2016/10/CHOICESlong10-16.pdf\`
*   **Title:** Applying for CHOICES to pay for your care in a nursing home or at home

[6] **Employment and Community First CHOICES**
*   **Source:** \`https://www.tn.gov/tenncare/long-term-services-supports/employment-and-community-first-choices.html\`
*   **Title:** Employment and Community First CHOICES

[7] **Katie Beckett Program**
*   **Source:** \`https://www.tn.gov/tenncare/long-term-services-supports/katie-beckett-program.html\`
*   **Title:** Katie Beckett Program

***

**SEO Keywords:** Tennessee Medicaid, TennCare, CHOICES Program, Assisted Living Waiver Tennessee, Long-Term Services and Supports (LTSS), TennCare Eligibility, CHOICES Group 2, Nursing Facility Level of Care (NFLOC), Tennessee Bureau of TennCare, Medicaid Financial Limits Tennessee.
`,i=`# Tennessee Licensing Authority: Oversight and Regulation of Long-Term Care Facilities
...
## The Regulatory Body: Board for Licensing Health Care Facilities
...
### Key Functions of the Board and Division
...
1.  **Licensure:** Issuing, renewing, and revoking licenses for over 21 types of health care facilities, including nursing homes and assisted care living facilities.
2.  **Certification:** Conducting surveys for federal certification, which allows facilities to participate in the Medicare and Medicaid (TennCare) programs.
3.  **Surveys and Inspections:** Performing routine, unannounced inspections (surveys) to assess compliance with state licensing regulations and federal certification requirements.
4.  **Complaint Investigation:** Investigating all complaints received against licensed facilities to determine if violations of standards have occurred.
5.  **Enforcement:** Imposing sanctions, such as civil monetary penalties (CMPs), license suspensions, or revocations, when facilities fail to correct deficiencies [1].
...
## Licensing and Regulation of Long-Term Care Facilities
...
*   **Initial Licensure:** A rigorous application process that includes a review of architectural plans, financial viability, and a pre-licensure survey to ensure the facility is built and equipped to meet all standards.
*   **Annual Renewal:** Licenses must be renewed annually, contingent upon the facility's continued compliance with state and federal regulations, as demonstrated through periodic inspections.
*   **Change of Ownership (CHOW):** Any change in the facility's ownership requires a new application and review to ensure the new operators are qualified and capable of maintaining quality care.
...
*   **Scope of Services:** Defining the maximum level of care an ACLF can provide, ensuring they do not operate as unlicensed nursing homes.
*   **Staffing:** Mandating minimum staffing levels and qualifications for direct care staff, including medication aides.
*   **Physical Environment:** Setting standards for resident rooms, common areas, safety features, and emergency preparedness.
...
*   **Resident Care:** Observing direct care, reviewing resident medical records, and interviewing residents and family members.
*   **Facility Operations:** Inspecting the physical plant, kitchen, and sanitation practices.
*   **Staffing:** Verifying staff qualifications, training, and appropriate staffing levels.
...
### Federal Certification Surveys (Medicare/Medicaid)
...
| :--- | :--- | :--- |
| **Plan of Correction (POC)** | Required for all deficiencies; facility must outline steps and timeline for correction. | Minor to Moderate |
| **Civil Monetary Penalties (CMPs)** | Fines imposed for serious or repeated violations of state or federal regulations. | Moderate to Severe |
| **Directed Plan of Correction** | The state mandates specific steps the facility must take to correct deficiencies. | Severe |
| **License Suspension or Revocation** | The most severe action, resulting in the facility being unable to operate. | Immediate Jeopardy or Chronic Non-Compliance |
| **Temporary Management** | The state appoints a temporary manager to operate the facility and correct deficiencies. | Severe, but with potential for recovery |
...
## Public Access to Information and Reports
...
*   **Nursing Home Reports:** Summaries of inspection findings, deficiencies cited, and enforcement actions taken.
*   **Health Facility Reports:** Data on various facility types, including ACLFs.
*   **Facility Action and Abuse Reports:** Records of substantiated findings of abuse, neglect, or misappropriation of resident property [7].
...
## Filing a Complaint with the Licensing Authority
...
*   **Agency:** Tennessee Department of Health, Division of Licensure and Regulation
*   **Phone:** **(615) 741-7221**
*   **Complaint Filing:** The state encourages the use of the **Public Records and Complaints portal** for all complaints against a licensed health care facility [8].
...
*   **Source:** \`https://www.tn.gov/hfc/division-of-licensure-and-regulation.html\`
*   **Title:** Division of Licensure information and related links

[2] **About the Board for Licensing Health Care Facilities**
*   **Source:** \`https://www.tn.gov/hfc/commission-meeting-information/board-for-licensing-health-care-facilities-meetings/about.html\`
*   **Title:** About the Board for Licensing Health Care Facilities

[3] **Rules of the Tennessee Department of Health, Board for Licensing Health Care Facilities**
*   **Source:** \`https://publications.tnsosfiles.com/rules/1200/1200-08/1200-08.htm\`
*   **Title:** 1200-08 - Health Care Facilities

[4] **Standards for Assisted-Care Living Facilities**
*   **Source:** \`https://publications.tnsosfiles.com/rules/1200/1200-08/1200-08-25.pdf\`
*   **Title:** 1200-8-25 Standards for assistance-care living facilities

[5] **HFC Licensure Applications and reports**
*   **Source:** \`https://www.tn.gov/hfc/division-of-licensure-and-regulation/hfc-licensure/licensure-applications.html\`
*   **Title:** Tennessee HFC Licensure Applications and reports

[6] **TN CMP Program**
*   **Source:** \`https://www.tn.gov/hfc/division-of-licensure-and-regulation.html\` (Referenced in the Division's responsibilities)
*   **Title:** Tennessee Civil Monetary Penalty Program

[7] **Tennessee Health Facilities publications and reports**
*   **Source:** \`https://www.tn.gov/hfc/publication-and-reports.html\`
*   **Title:** Tennessee Health Facilities publications and reports

[8] **Information on how to file a complaint against a provider**
*   **Source:** \`https://www.tn.gov/hfc/division-of-licensure-and-regulation/filing-a-complaint.html\`
*   **Title:** Information on how to file a complaint against a provider

***

**SEO Keywords:** Tennessee Nursing Home Licensing, Assisted Care Living Facility (ACLF) Regulation Tennessee, Tennessee Department of Health Licensure, Board for Licensing Health Care Facilities, Tennessee Health Facility Commission, Nursing Home Inspection Reports Tennessee, Tennessee Division of Licensure and Regulation, Health Care Facility Survey Process.
`,t=`# Tennessee Long-Term Care Ombudsman and Advocacy: Protecting Resident Rights and Dignity
...
*   **Investigating and Resolving Complaints:** The most visible function is the investigation of complaints made by or on behalf of residents. These complaints can range from minor issues like food quality to serious concerns about abuse, neglect, or violations of resident rights.
*   **Advocating for Resident Rights:** The Ombudsman ensures that residents are aware of their rights under federal and state law and works to uphold those rights, including the right to privacy, the right to make independent choices, and the right to be treated with dignity and respect.
*   **Providing Information and Education:** The program offers information to residents, families, and the public about long-term care services, resident rights, and the complaint resolution process.
*   **Promoting Systemic Change:** Beyond individual case resolution, the Ombudsman analyzes complaint data and works with facility staff, government agencies, and legislators to recommend and promote changes in laws, regulations, and policies that affect the long-term care system [2].
...
*   **Program:** Tennessee Office of the State Long-Term Care Ombudsman
*   **Statewide Phone:** **(877) 236-0013**

### District Long-Term Care Ombudsmen
...
| :--- | :--- | :--- |
| **1. Intake** | A complaint is received via phone, email, or in-person visit from a resident, family member, or concerned citizen. | The Ombudsman records the complaint and confirms the resident's consent to proceed. |
| **2. Investigation** | The Ombudsman visits the facility, interviews the resident, staff, and other relevant parties, and reviews records. | The Ombudsman gathers facts while maintaining strict confidentiality. |
| **3. Resolution** | The Ombudsman works with the resident and facility staff to find a mutually agreeable solution. This often involves mediation, negotiation, or education. | The goal is to resolve the issue to the satisfaction of the resident. |
| **4. Referral** | If the complaint involves issues outside the Ombudsman's scope (e.g., abuse, neglect, or licensure violations), it is referred to the appropriate agency, such as the Department of Health or Adult Protective Services. | The Ombudsman ensures the complaint is directed to the authority with the power to act. |
| **5. Follow-up** | The Ombudsman follows up to ensure the resolution has been implemented and the problem has not recurred. | The case is closed only after the resident's concerns have been addressed. |
...
## Advocacy Beyond the Ombudsman: Legal and Protective Services
...
*   **Guardianship and Conservatorship:** Assisting families in establishing legal authority to make decisions for an incapacitated resident.
*   **Medicaid Appeals:** Representing residents who have been denied Medicaid eligibility or services.
*   **Eviction and Transfer Appeals:** Challenging a facility's decision to involuntarily discharge or transfer a resident.
...
*   **APS Hotline:** The state maintains a dedicated hotline for reporting suspected abuse, neglect, or exploitation.
*   **Mandatory Reporting:** Many professionals, including facility staff and Ombudsmen, are **mandatory reporters** and are legally required to report suspected abuse to APS.

### The Tennessee Quality Improvement Organization (QIO)
...
*   **Appeals of Discharge:** Reviewing the medical necessity of a discharge from a hospital or skilled nursing facility.
*   **Quality of Care Concerns:** Providing information and assistance regarding concerns about the quality of medical care received.

## Empowering Residents: Knowing Your Rights
...
*   The right to be fully informed of services and charges.
...
*   The right to be free from physical or mental abuse, corporal punishment, involuntary seclusion, and any physical or chemical restraints imposed for purposes of discipline or convenience [4].
...
[2] **Ombudsman Program Functions and Services**
*   **Source:** \`https://www.ltcombudsman.org/about/what-is-an-ombudsman\`
*   **Title:** What is an Ombudsman?

[3] **District Long-Term Care Ombudsman**
*   **Source:** \`https://www.tn.gov/disability-and-aging/disability-aging-programs/long-term-care-ombudsman/district-long-term-care-ombudsman.html\`
*   **Title:** District Long-Term Care Ombudsman

[4] **Tennessee Residents' Bill of Rights**
*   **Source:** *Reference to Tennessee state law or regulation on resident rights, typically found in the Tennessee Code Annotated or Rules of the Department of Health.*
*   **Title:** Tennessee Long-Term Care Residents' Bill of Rights
...
`,a=`# Tennessee Long-Term Care Complaint Process: A Guide to Reporting Concerns and Ensuring Accountability
...
## The Primary Regulatory Authority: Tennessee Department of Health
...
### The Health Care Facilities Complaint Hotline
...
*   **Health Care Facilities Complaint Hotline:** **(877) 287-0010**
*   **Purpose:** To report concerns about the quality of care, resident safety, sanitation, staffing levels, or any violation of licensing standards in a licensed facility.
*   **Availability:** The hotline is typically available during standard business hours, with procedures in place for reporting urgent, life-threatening situations after hours.

### Filing a Complaint with the Division of Licensure and Regulation
...
#### 1. Online Submission (Public Records and Complaints Portal)
...
*   A detailed description of the incident(s), including dates, times, and names of staff involved.
*   The name and contact information of the complainant (which can be kept confidential upon request).

**Mailing Address for Complaints:**
Tennessee Department of Health
Division of Licensure and Regulation
Centralized Complaint Intake Unit
[Current Address - *Note: The address may change, refer to the official website for the most current information*]

### The Investigation Process (TDH)

Once a complaint is received, the TDH follows a structured investigation process:

1.  **Triage and Prioritization:** Complaints are assessed for severity. Those alleging immediate jeopardy to a resident's health or safety are prioritized and investigated within two business days. Less severe complaints are investigated within a set timeframe.
2.  **Unannounced Survey:** The investigation is typically conducted through an **unannounced on-site survey** by state surveyors. This surprise visit is crucial for observing conditions as they normally exist.
3.  **Fact-Finding:** Surveyors interview the resident, family members, staff, and management; review medical records, staffing schedules, and facility policies; and observe the care provided and the physical environment.
4.  **Findings and Enforcement:** If the investigation substantiates the complaint, the facility is cited for deficiencies and must submit a **Plan of Correction (POC)**. Depending on the severity, the TDH may impose sanctions, including civil monetary penalties (CMPs) or, in extreme cases, license revocation [1].

## The Advocacy Channel: Long-Term Care Ombudsman
...
*   **Resident Rights:** Violations of the right to privacy, dignity, or self-determination.
*   **Quality of Life:** Concerns about food, activities, social isolation, or responsiveness of staff.
*   **Communication:** Disputes with facility management or staff regarding care planning or information access.
*   **Transfer/Discharge:** Concerns about involuntary discharge or transfer notices.

*   **Ombudsman Phone:** **(877) 236-0013**
*   **Agency:** Tennessee Commission on Aging and Disability (TCAD)

### The Ombudsman's Resolution Process
...
*   **Direct Advocacy:** Speaking with facility staff and management on behalf of the resident.
*   **Mediation:** Facilitating a discussion between the resident and the facility to reach a mutually acceptable solution.
*   **Referral:** If the complaint involves suspected abuse, neglect, or exploitation, the Ombudsman is legally required to refer the case immediately to **Adult Protective Services (APS)** and/or the TDH.

## Reporting Abuse, Neglect, and Exploitation (Adult Protective Services)
...
*   **APS Hotline:** The state maintains a dedicated, confidential hotline for reporting suspected abuse. *Note: While the TDH hotline is for facility complaints, the APS hotline is for the protection of the vulnerable adult.*
*   **Mandatory Reporting:** Tennessee law mandates that certain professionals, including healthcare workers and Ombudsman staff, must report suspected abuse, neglect, or exploitation.

| Type of Complaint | Primary Contact | Phone Number | Focus |
| :--- | :--- | :--- | :--- |
| **Regulatory Violations** (Care, Staffing, Sanitation) | TN Dept. of Health (TDH) Complaint Hotline | **(877) 287-0010** | Licensing and Certification Compliance |
| **Resident Rights/Quality of Life** (Dignity, Choice, Grievances) | Long-Term Care Ombudsman | **(877) 236-0013** | Advocacy and Mediation |
| **Abuse, Neglect, Exploitation** (Harm to a Vulnerable Adult) | Adult Protective Services (APS) | *Refer to local DHS or state APS contact* | Investigation and Protection |
...
*   **The Incident:** Date, time, location, and a detailed description of what happened.
*   **Witnesses:** Names and contact information of any staff or residents who witnessed the event.
*   **Previous Reports:** Any prior attempts to resolve the issue with facility staff or management.
*   **The Complaint Filing:** The date the complaint was filed, the agency it was filed with, and any reference or case number provided.
...
[2] **Tennessee Health Facilities Commission Public Records and Complaints Portal**
*   **Source:** \`https://www.tn.gov/hfc/division-of-licensure-and-regulation/filing-a-complaint.html\` (Referenced as the preferred method)
*   **Title:** Public Records and Complaints Portal
...
[4] **Health Hotlines**
*   **Source:** \`https://www.tn.gov/health/health-program-areas/std/std/health-hotlines.html\`
*   **Title:** Health Hotlines

***

**SEO Keywords:** Tennessee Nursing Home Complaint, Tennessee Assisted Living Complaint Process, TN Department of Health Complaint Hotline, How to Report a Nursing Home in Tennessee, Tennessee Long-Term Care Complaint Number, (877) 287-0010, Tennessee Adult Protective Services.
`,s=`# Tennessee Veterans Benefits: A Comprehensive Guide to State and Federal Resources
...
*   **Claims Assistance:** Assist veterans and their dependents in preparing, filing, and prosecuting claims for federal benefits from the U.S. Department of Veterans Affairs (VA).
*   **Resource Coordination:** Connect veterans with state-specific programs, including tax exemptions, employment services, and educational benefits.
*   **Advocacy:** Act as an advocate for veterans in their dealings with the VA and other government agencies.
...
## Healthcare and Long-Term Care: Tennessee State Veterans Homes
...
1.  **Humboldt Veterans Home**
2.  **Murfreesboro Veterans Home**
3.  **Clarksville Veterans Home**
4.  **Knoxville Veterans Home**
5.  **Cleveland Veterans Home**

#### Eligibility and Admission

Admission to a Tennessee State Veterans Home is open to veterans who meet the following criteria:
*   **Veteran Status:** Must be a veteran who was honorably discharged from active military service.
*   **Residency:** Must be a resident of Tennessee.
*   **Medical Need:** Must be in need of a skilled level of care, domiciliary care, or assisted living services as determined by a medical assessment.
...
*   **Eligibility:** The veteran must have a service-connected disability that is **100% permanent and total** or have been rated as individually unemployable by the VA.
*   **Surviving Spouses:** The surviving spouse of a veteran who qualified for this exemption, or a veteran who died from a service-connected cause, may also be eligible for this relief.
...
*   **Free Disabled Veteran License Plates:** Veterans with a 100% service-connected disability are eligible for a free set of disabled veteran license plates.
*   **Exemption from Motor Vehicle Privilege Tax:** Veterans who are 100% permanently and totally disabled are exempt from the motor vehicle privilege tax on one vehicle.
...
*   **Tennessee Reconnect Grant:** While not exclusively for veterans, this grant helps adults return to higher education. Veterans can also utilize the **Helping Heroes Grant**, which provides up to **$1,000 per semester** for qualifying veterans and service members completing 12 hours, helping to cover costs not fully met by the GI Bill [6].
*   **In-State Tuition:** Veterans, active-duty service members, and their dependents are generally eligible for in-state tuition rates at Tennessee public colleges and universities, regardless of the length of time they have resided in the state.
...
*   **Veterans Preference:** Qualified veterans are given preference over non-veterans with the same qualifications.
*   **Veterans' Employment and Training Service (VETS):** The TDVS works closely with the Tennessee Department of Labor and Workforce Development to provide job training, counseling, and placement services through the state's American Job Centers.

## Burial and Memorial Benefits

The state honors its deceased veterans with solemn burial and memorial benefits.

*   **Tennessee State Veterans Cemeteries:** Tennessee operates several State Veterans Cemeteries, providing a final resting place for eligible veterans, their spouses, and dependent children. Burial in a State Veterans Cemetery is provided at no cost to the veteran's family.
*   **Headstone/Marker Setting:** The TDVS assists families in applying for and setting the federal government-provided headstone or marker in private cemeteries.

## Summary of Key Tennessee Veterans Benefits

| Benefit Category | Specific Tennessee Program/Benefit | Key Eligibility Requirement |
| :--- | :--- | :--- |
| **Long-Term Care** | Tennessee State Veterans Homes (5 locations) | Honorably discharged veteran, TN resident, need for skilled/domiciliary care. |
| **Financial/Tax** | Property Tax Relief | 100% permanent and total service-connected disability. |
| **Financial/Tax** | Military Retirement Pay | Full exemption from state income tax. |
| **Education** | Helping Heroes Grant | Qualifying veteran/service member, completing 12 hours per semester. |
| **Employment** | Veterans Preference | Qualified veteran status for state/local government jobs. |
| **Burial** | State Veterans Cemeteries | Eligible veteran, spouse, or dependent child. |

## Conclusion: Honoring Service with Support
...
*   **Source:** \`https://www.tn.gov/veteran.html\`
*   **Title:** Tennessee Department of Veterans Services

[2] **State Veterans Homes**
*   **Source:** \`https://www.tn.gov/veteran/veteran-benefits/tn-state-benefits/state-veterans-homes.html\`
*   **Title:** State Veterans Homes

[3] **Admissions and Cost - Tennessee State Veterans Home**
*   **Source:** \`https://tsvh.org/admissions-and-cost/\`
*   **Title:** Admissions and Cost

[4] **Property Tax Relief for Disabled Veterans**
*   **Source:** \`https://www.tn.gov/veteran/veteran-benefits/tn-state-benefits/property-tax-relief.html\`
*   **Title:** Property Tax Relief for Disabled Veterans

[5] **Tennessee Military and Veterans Benefits**
*   **Source:** \`https://myarmybenefits.us.army.mil/Benefit-Library/State/Territory-Benefits/TENNESSEE\`
*   **Title:** Tennessee Military and Veterans Benefits

[6] **Education Benefits for Veterans and Active Duty**
*   **Source:** \`https://tnreconnect.gov/Pay-For-College/Education-Benefits-for-Veterans-and-Active-Duty\`
*   **Title:** Education Benefits for Veterans and Active Duty

***

**SEO Keywords:** Tennessee Veterans Benefits, Tennessee State Veterans Homes, Tennessee Department of Veterans Services, Property Tax Relief for Disabled Veterans Tennessee, Tennessee Military Retirement Pay Tax, Helping Heroes Grant Tennessee, TSVH Eligibility, Veterans Employment Preference Tennessee.
`,r={licensing:{name:"Tennessee Bureau of TennCare",phone:""},ombudsman:{name:"Area Agencies on Aging and Disability (AAAD)",phone:""},medicaid:{name:"Tennessee Bureau of TennCare",phone:""},elderAbuse:{name:"Tennessee Department of Human Services (DHS)",phone:""}},o={state_slug:e,medicaid_content:n,licensing_content:i,ombudsman_content:t,complaints_content:a,veterans_content:s,contacts_json:r};export{a as complaints_content,r as contacts_json,o as default,i as licensing_content,n as medicaid_content,t as ombudsman_content,e as state_slug,s as veterans_content};

  ...
  const posts = [
    {
      ...
      content: (
        <div className="space-y-8 text-lg text-charcoal leading-relaxed">
          <p className="font-medium text-xl text-charcoal">
          ...
          <div className="bg-primary-50 border-l-4 border-primary-500 p-6 rounded-r-lg">
            <h3 className="text-xl font-bold text-primary-900 mb-2">1. The Care Level Conundrum (The Biggest Surprise)</h3>
            ...
            <p className="mt-4 font-bold text-primary-800">Action: Always ask for the price breakdown for the highest expected level of care and insist on seeing the facility's official assessment criteria before touring.</p>
          </div>

          <div>
            <h3 className="text-2xl font-bold text-charcoal mb-4">2. Medication Management and Supply Fees</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold text-charcoal mb-4">3. Move-In Fees and Community Fees</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-8 text-lg text-charcoal leading-relaxed">
          ...
          <div>
            <h3 className="text-2xl font-bold text-charcoal mb-4">1. Understanding the Severity Score (The Most Critical Filter)</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold text-charcoal mb-4">2. The California System (The RCFE Scale)</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm text-left">
                <thead className="bg-warm-gray text-charcoal font-bold">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-200 border border-warm-gray">
                  ...
                  <tr className="bg-primary-50">
                    <td className="p-3 font-bold text-primary-800">Type B</td>
                    <td className="p-3">Risk to Health or Safety. A less severe violation that still has an impact on the resident.</td>
                    <td className="p-3 font-bold text-primary-800">Serious Concern. Indicates a system failure that needs deep investigation.</td>
                  </tr>
          ...
          <div>
            <h3 className="text-2xl font-bold text-charcoal mb-4">3. The Texas & Florida System (Focusing on Scope and Severity)</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm text-left">
                ...
                <tbody className="divide-y divide-slate-200 border border-warm-gray">
                  ...
                  <tr className="bg-primary-50">
                    <td className="p-3 font-bold text-primary-800">B</td>
                    <td className="p-3">Minimal Harm/No Harm Caused</td>
                    <td className="p-3">Pattern (Multiple residents).</td>
                    <td className="p-3 font-bold text-primary-800">Moderate risk. Indicates a systemic problem.</td>
                  </tr>
                  <tr className="bg-red-50">
          ...
          <div className="bg-primary-50 border-l-4 border-primary-500 p-6 rounded-r-lg">
            <h3 className="text-xl font-bold text-primary-900 mb-4">The SilverTech Action Plan for Families</h3>
      ...
      content: (
        <div className="space-y-8 text-lg text-charcoal leading-relaxed">
          ...
          <div className="grid gap-6">
            <div className="bg-warm-white p-6 rounded-xl border border-warm-gray">
              <h3 className="text-xl font-bold text-charcoal mb-3">1. The "Whose Job Is This?" Syndrome (Staff Knowledge)</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                    <span className="font-bold text-charcoal/70 min-w-[80px]">Implication:</span>
            ...
            <div className="bg-warm-white p-6 rounded-xl border border-warm-gray">
              <h3 className="text-xl font-bold text-charcoal mb-3">2. The Missing Whiteboards (Communication Failure)</h3>
            ...
            <div className="bg-warm-white p-6 rounded-xl border border-warm-gray">
              <h3 className="text-xl font-bold text-charcoal mb-3">3. The Atmosphere of Rushed Chaos (Staff Stress)</h3>
            ...
            <div className="bg-warm-white p-6 rounded-xl border border-warm-gray">
              <h3 className="text-xl font-bold text-charcoal mb-3">4. The "No One Is Around" Effect (Understaffing)</h3>
      ...
      <div className="min-h-screen bg-white font-sans">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <Button 
            ...
            className="mb-8 text-charcoal/60 hover:text-charcoal pl-0"
          >
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-charcoal font-serif mt-4 mb-6 leading-tight">
              {selectedPost.title}
            </h1>
    ...
    <div className="min-h-screen bg-warm-white font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-8">
          {posts.map((post) => (
            <div key={post.id} className="bg-white rounded-xl shadow-sm border border-warm-gray overflow-hidden hover:shadow-md transition-shadow flex flex-col">
              <div className="p-6 flex-1">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-bold uppercase tracking-wider text-charcoal/60 bg-warm-gray px-2 py-1 rounded">
                    {post.category}
                  </span>
                ...
                <h3 className="text-xl font-bold text-charcoal mb-3 font-serif leading-tight">
                  {post.title}
                </h3>
      ...
      <div className="bg-charcoal text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-charcoal/30 mb-10 max-w-2xl mx-auto">

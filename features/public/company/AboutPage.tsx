...
export const AboutPage: React.FC = () => {
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            {/* Hero Section */}
            <div className="bg-gradient-to-br from-primary-50 via-primary-50 to-white">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
                ...
                <section>
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-charcoal">Why You Can Trust Our Listings</h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="bg-warm-white p-6 rounded-xl border border-warm-gray">
                            <div className="flex items-center gap-3 mb-3">
                                <DollarSign className="w-6 h-6 text-charcoal/70" />
                                <h4 className="font-semibold text-charcoal">Conflict of Interest</h4>
                            </div>
                        ...
                        <div className="bg-warm-white p-6 rounded-xl border border-warm-gray">
                            <div className="flex items-center gap-3 mb-3">
                                <AlertCircle className="w-6 h-6 text-charcoal/70" />
                                <h4 className="font-semibold text-charcoal">Hidden Costs</h4>
                            </div>
                            <p className="text-charcoal">
                    ...
                    <div className="bg-gradient-to-br from-primary-50 to-primary-50 p-8 rounded-2xl border-2 border-primary-200">
                        <div className="flex items-start gap-4">
                            <div className="p-3 bg-white rounded-xl shadow-sm">
                                <CheckCircle className="w-8 h-8 text-primary-600" />
                            </div>
                            <div>
                                <h3 className="text-2xl font-bold text-charcoal mb-3">We Are Different</h3>
                ...
                <section>
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-charcoal">The Full Spectrum of Care, Clearly Presented</h2>
                    </div>
                    ...
                    <div className="bg-white border-2 border-warm-gray rounded-2xl overflow-hidden">
                        ...
                        <div className="divide-y divide-slate-200">
                            <div className="p-6 flex items-start gap-4 hover:bg-warm-white transition-colors">
                                <div className="p-2 bg-primary-100 rounded-lg">
                                    <FileText className="w-6 h-6 text-primary-600" />
                                </div>
                                <div>
                                    <h4 className="font-bold text-charcoal mb-2">Verified Data</h4>
                                    <p className="text-charcoal">
                            ...
                            <div className="p-6 flex items-start gap-4 hover:bg-warm-white transition-colors">
                                ...
                                <div>
                                    <h4 className="font-bold text-charcoal mb-2">Objective Rankings</h4>
                                    <p className="text-charcoal">
                            ...
                            <div className="p-6 flex items-start gap-4 hover:bg-warm-white transition-colors">
                                ...
                                <div>
                                    <h4 className="font-bold text-charcoal mb-2">Direct Contact</h4>
                                    <p className="text-charcoal">
                ...
                <section>
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-charcoal">How We Keep the Site Free For You</h2>
                    </div>
                    ...
                    <div className="bg-primary-50 border border-primary-200 rounded-xl p-8">
                        ...
                        <p className="text-lg text-charcoal font-medium">
                            However, we <strong className="text-primary-900">never shove ads in your face</strong>, and they do not influence
                ...
                <section className="text-center py-12">
                    <div className="inline-block p-6 bg-gradient-to-br from-primary-600 to-primary-600 rounded-2xl shadow-xl mb-6">

            ...
            {loading ? (
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
                ...
                <div className="prose prose-slate max-w-none text-slate-600">
                  ...
                  <div className="bg-primary-50 p-4 rounded-lg border border-primary-100 not-prose mt-4">
                    <h4 className="font-semibold text-primary-900 mb-2">The "Room & Board" Gap</h4>
          ...
          <div className="space-y-6">
            ...
            {regulatoryData?.contacts_json?.medicaid && (
              <div className="bg-primary-50 p-6 rounded-xl border border-primary-100">
                <h3 className="font-bold text-primary-900 mb-2">State Medicaid Contact</h3>
                <p className="font-medium text-primary-900">{regulatoryData.contacts_json.medicaid.name}</p>
                {regulatoryData.contacts_json.medicaid.phone && (
                  <p className="text-primary-800 mt-2">Phone: {regulatoryData.contacts_json.medicaid.phone}</p>
                )}
              </div>
            )}
          </div>
